...
- **Espace admin** : gestion des produits, catégories, bannières, commandes, FAQ, Blog, Témoignages.
- **Bannières** : slideshow avec navigation et personnalisation.
- **Blog** : Gestion des blogs du site.
- **Témoignage** : Gestion des témoignages du site.
...
2. Installez les dépendances :
 ...
 //Créer le lien symbolique pour les images
   ...
   ```
3. Faire migration de bdd et des seeders
       ```
   php artisan migrate
   php artisan db:seed
...
- Accédez à l’espace admin : `/admin/login` (email par défaut:admin@example.com ; mot de passe par défaut : `password`)
- Gérez les produits, catégories, commandes, FAQ, Blog, Témoignages bannières depuis l’admin.
...
**Les 2 layouts ne sont pas à Supprimer dans views**
