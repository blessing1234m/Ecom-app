    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto text-center">
                        ...
                        <dl class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <dd class="font-medium text-primary-600">
                                    {{ number_format($order->total_amount, 0, ',', ' ') }} FCFA</dd>
                            </div>
                        </dl>
                    </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('orders.pdf.download', $order) }}"
            ...
            <div class="mt-8 text-center text-sm text-gray-500">
                ...
                <p class="mt-1">Contactez-nous au <strong>+228 XX XX XX XX</strong> ou
                    <strong>contact@ecom-app.tg</strong></p>
            </div>
        </div>
    </div>
@endsection
